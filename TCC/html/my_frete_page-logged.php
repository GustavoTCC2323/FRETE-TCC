        ...
        <div class="row">
            <div class="col-md-12 offset-md-0">
                <div class="cadastro-fretes-form">
                    <form action="./cancela_contrato.php" method="POST" class="my-5 border p-4 bg-dark text-light shadow">
                        <h4 class=" mb-5 text-secondary">Serviço iniciado</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="btn btn-danger float-end" type="submit" value="Cancelar frete">
