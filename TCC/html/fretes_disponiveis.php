        ...
        <table class="table table-dark table-hover">
            ...
            <tbody class="">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                    <a class='btn btn-sm btn-outline-primary' href='./frete_page.php?id=$row[id]'>
...
<script>
    ...
    function searchData() {
        window.location = 'fretes_disponiveis.php?search=' + search.value;
    }

    function porData() {
        window.location = 'fretes_disponiveis.php?order=data';
    }
</script>
