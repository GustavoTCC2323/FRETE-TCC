        ...
        <div class="row">
            <div class="col-md-12 offset-md-0">
                <div class="cadastro-fretes-form">
                    <form action="./login-page.php" method="POST" class="my-5 border p-4 bg-dark text-light shadow">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-success float-end me-1" href="./fretes_disponiveis.php">Voltar</a>
                                </div>
                    </form>
